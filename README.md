...
하지만 '봄' 점자 학습 어플리케이션은, '개발자'가 되고 싶다는 마음을 불러 일으켜 준, 우리 팀의 대학 생활을 대표하는 프로젝트입니다. 단순히 우리가 생각했을 때 필요한 기능들이 아닌, 실제 사용할 시각장애인분들을 찾아가 이야기를 직접 들으며 개발되었습니다. 오랜 시간동안 의사소통이 해야했고, 어떻게 기능 구현을 해야 할 지 몰라 개발을 하면서 성장했습니다. 코드의 품질을 떠나, 참 애틋한 프로젝트입니다.
