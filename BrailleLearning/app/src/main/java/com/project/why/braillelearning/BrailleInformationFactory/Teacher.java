...
public class Teacher extends LearningInformation implements Getting {
    Teacher(){
        setBrailleLength(Constant.BRAILLE_LENGTH_LONG);
        setBrailleDataType(Constant.SERVER);
        setJsonFileNameArray(Constant.TEACHER_JSON);
        setBrailleLearningType(Constant.LEARNING_TEACHER);
